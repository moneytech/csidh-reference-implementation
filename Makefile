...
util-test: static-library
	echo "BEGIN util-test"
	./csidh-p512-util -d -p sample-keys/1.pk -s sample-keys/2.sk > sample-keys/1-2.ss.test_result
	diff sample-keys/1-2.ss.test_result sample-keys/1-2.ss
	./csidh-p512-util -d -p sample-keys/2.pk -s sample-keys/1.sk > sample-keys/2-1.ss.test_result
	diff sample-keys/2-1.ss.test_result sample-keys/2-1.ss
	./csidh-p512-util -d -p sample-keys/3.pk -s sample-keys/2.sk > sample-keys/3-2.ss.test_result
	diff sample-keys/3-2.ss.test_result sample-keys/3-2.ss
	./csidh-p512-util -d -p sample-keys/4.pk -s sample-keys/3.sk > sample-keys/4-3.ss.test_result
